...
const (
	...
	AuthServiceName = "echo.v1.AuthService"
)
...
const (
	...
	AuthServiceRegisterProcedure = "/echo.v1.AuthService/Register"
	// AuthServiceLoginProcedure is the fully-qualified name of the AuthService's Login RPC.
	AuthServiceLoginProcedure = "/echo.v1.AuthService/Login"
	// AuthServiceRefreshProcedure is the fully-qualified name of the AuthService's Refresh RPC.
	AuthServiceRefreshProcedure = "/echo.v1.AuthService/Refresh"
...
var (
	authServiceServiceDescriptor        = v1.File_echo_v1_auth_proto.Services().ByName("AuthService")
	...
	authServiceGetMeMethodDescriptor    = authServiceServiceDescriptor.Methods().ByName("GetMe")
)
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	return &authServiceClient{
		...
		getMe: connect.NewClient[v1.GetMeRequest, v1.GetMeResponse](
			...
			connect.WithSchema(authServiceGetMeMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
	}
}
...
// Login calls echo.v1.AuthService.Login.
...
// Refresh calls echo.v1.AuthService.Refresh.
...
// Logout calls echo.v1.AuthService.Logout.
...
// GetMe calls echo.v1.AuthService.GetMe.
...
func (UnimplementedAuthServiceHandler) Register(context.Context, *connect.Request[v1.RegisterRequest]) (*connect.Response[v1.AuthResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("echo.v1.AuthService.Register is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) Login(context.Context, *connect.Request[v1.LoginRequest]) (*connect.Response[v1.AuthResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("echo.v1.AuthService.Login is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) Refresh(context.Context, *connect.Request[v1.RefreshRequest]) (*connect.Response[v1.AuthResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("echo.v1.AuthService.Refresh is not implemented"))
}

func (UnimplementedAuthServiceHandler) Logout(context.Context, *connect.Request[v1.LogoutRequest]) (*connect.Response[v1.LogoutResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("echo.v1.AuthService.Logout is not implemented"))
}
