...
var (
	financeServiceServiceDescriptor                          = v1.File_echo_v1_finance_proto.Services().ByName("FinanceService")
	financeServiceCreateAccountMethodDescriptor              = financeServiceServiceDescriptor.Methods().ByName("CreateAccount")
	financeServiceListAccountsMethodDescriptor               = financeServiceServiceDescriptor.Methods().ByName("ListAccounts")
	financeServiceCreateCategoryMethodDescriptor             = financeServiceServiceDescriptor.Methods().ByName("CreateCategory")
	financeServiceListCategoriesMethodDescriptor             = financeServiceServiceDescriptor.Methods().ByName("ListCategories")
	financeServiceImportTransactionsCsvMethodDescriptor      = financeServiceServiceDescriptor.Methods().ByName("ImportTransactionsCsv")
	financeServiceListTransactionsMethodDescriptor           = financeServiceServiceDescriptor.Methods().ByName("ListTransactions")
	financeServiceCreateGoalMethodDescriptor                 = financeServiceServiceDescriptor.Methods().ByName("CreateGoal")
	financeServiceListGoalsMethodDescriptor                  = financeServiceServiceDescriptor.Methods().ByName("ListGoals")
	financeServiceListRecurringSubscriptionsMethodDescriptor = financeServiceServiceDescriptor.Methods().ByName("ListRecurringSubscriptions")
)
...
func NewFinanceServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FinanceServiceClient {
	...
	return &financeServiceClient{
		createAccount: connect.NewClient[v1.CreateAccountRequest, v1.CreateAccountResponse](
			...
			connect.WithSchema(financeServiceCreateAccountMethodDescriptor),
		...
		listAccounts: connect.NewClient[v1.ListAccountsRequest, v1.ListAccountsResponse](
			...
			connect.WithSchema(financeServiceListAccountsMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		createCategory: connect.NewClient[v1.CreateCategoryRequest, v1.CreateCategoryResponse](
			...
			connect.WithSchema(financeServiceCreateCategoryMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		listCategories: connect.NewClient[v1.ListCategoriesRequest, v1.ListCategoriesResponse](
			...
			connect.WithSchema(financeServiceListCategoriesMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		importTransactionsCsv: connect.NewClient[v1.ImportTransactionsCsvRequest, v1.ImportTransactionsCsvResponse](
			...
			connect.WithSchema(financeServiceImportTransactionsCsvMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		...
		listRecurringSubscriptions: connect.NewClient[v1.ListRecurringSubscriptionsRequest, v1.ListRecurringSubscriptionsResponse](
			...
			connect.WithSchema(financeServiceListRecurringSubscriptionsMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
	}
}
